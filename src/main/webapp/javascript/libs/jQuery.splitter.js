...
//                                                                panel_2.width( (self.width() - pw) * 100 / $(window).width() + "%" );
                                                                splitter.css('left', pw - sw2);
//                                                                splitter.css('left', (pw - sw2) * 100 / $(window).width() + "%");
                                                        } else {
                                                                pw = panel_1.width(position - sw2).outerWidth();
                                                                panel_2.width(self.width() - pw - sw);
//                                                                panel_2.width( (self.width() - pw - sw) * 100 / $(window).width() + "%" );
                                                                splitter.css('left', pw);
//                                                                splitter.css('left', (pw) * 100 / $(window).width() + "%");
                                                        }
...
//                                                                panel_2.height( (self.height() - pw) * 100 / $(window).height() + "%" );
                                                                splitter.css('top', pw - sw2);
//                                                                splitter.css('top', (pw - sw2) * 100 / $(window).height() + "%" );
                                                        } else {
                                                                pw = panel_1.height(position - sw2).outerHeight();
                                                                panel_2.height(self.height() - pw - sw);
//                                                                panel_2.height( (self.height() - pw - sw) * 100 / $(window).height() + "%" );
                                                                splitter.css('top', pw);
//                                                                splitter.css('top', (pw) * 100 / $(window).height() + "%" );
                                                        }
                                                }
                                                if (!silent) {
                                                        self.trigger('splitter.resize');

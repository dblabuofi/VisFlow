var exampleTwentySix = {
	"nodes": [
			...
			"resourcesOut": [
				{
					...
					"urlReturnFileType": "XML",
					"resourceType": "XML",
					"id": "b3d71cc2-26b8-9342-3c8b-a70ce94beb81",
					"location": "C:/Users/jupiter/Documents/NetBeansProjects/AutoInterfaceWS/data/"
				}
			],
			"font": {
		...
		},
		{
			...
			"resourcesIn": [
				...
				},
				{
					...
					"urlReturnFileType": "XML",
					"resourceType": "XML",
					"id": "dfd482f9-8c5a-63e2-289c-d4df1b614f73",
					"location": "C:/Users/jupiter/Documents/NetBeansProjects/AutoInterfaceWS/data/"
				}
			],
			"resourcesOut": [
		...
		{
			"id": "9b759f7b-9c3a-4b08-a7a2-884368adfcc8",
			"x": -10.99353670059613,
			"y": 425.7667863374769,
			"label": "",
			"timestamp": 1479093184624,
			"type": "analytics",
			"image": "image/analytics.png",
			"shape": "image",
			"resources": [],
			...
			"resourcesOut": [
				{
					...
					"urlReturnFileType": "XML",
					"resourceType": "XML",
					"id": "45f44010-b4b4-d417-08a9-1a45e167a845",
					"location": "C:/Users/jupiter/Documents/NetBeansProjects/AutoInterfaceWS/data/"
				}
			],
			"font": {
		...
		{
			"id": "7d9ae066-ba8a-42fa-8c5f-b2c0cc3c49c5",
			"x": -199.04730361185193,
			"y": 383.53198370005117,
			"label": "",
			"timestamp": 1479096467365,
			"type": "analytics",
			"image": "image/analytics.png",
			"shape": "image",
			"resources": [],
			...
			"resourcesOut": [
				{
					"urlReturnFileName": "cords.xml",
					"urlReturnFileType": "XML",
					"resourceType": "XML",
					"id": "e10f787e-6117-6532-d6e7-814b0115a897",
					"location": "C:/Users/jupiter/Documents/NetBeansProjects/AutoInterfaceWS/data/"
				}
			],
			"font": {
		...
		{
			"id": "5ed10548-2586-49dd-921b-dfa3d94f5a7f",
			"x": -364.6230171222072,
			"y": 205.79801844317487,
			"label": "",
			"timestamp": 1479109740936,
			"type": "analytics",
			"image": "image/analytics.png",
			"shape": "image",
			"resources": [],
			...
			"resourcesOut": [
				{
					...
					"urlReturnFileType": "CSV",
					"resourceType": "CSV",
					"id": "4667d968-9491-fddb-48c5-9c10350dd011",
					"location": "C:/Users/jupiter/Documents/NetBeansProjects/AutoInterfaceWS/data/"
				}
			],
			"font": {
			...
			"actions": [
				{
					"id": "6019a37a-cb23-e0d9-664a-abab981b9a38",
					"act": "Code",
					"val": "import xml.etree.ElementTree\nimport codecs\n\ndef combineTables():\n\thandle = open(\"comTable.csv\", \"r\");\n\te = xml.etree.ElementTree.parse('cords.xml').getroot();\n\ttarget = open(\"table.csv\", \"w\");\n\t\n\tlongList = list();\n\tlatList = list();\n\tfor feature in e.findall('coordinates'):\n\t\tlong = feature.find('array[0]').text;\n\t\tlat = feature.find('array[1]').text;\n\t\tlongList.append(long);\n\t\tlatList.append(lat);\n\t\n\ti = 0;\n\tfor line in handle:\n\t\tif i == 0:\n\t\t\twords = line.split(\",\");\n\t\t\twords.insert(4, \"Paleo Coordinates\");\n\t\t\ttarget.write(\",\".join(words));\n\t\telse:\n\t\t\twords = line.split(\",\");\n\t\t\tif words[1] == \"\":\n\t\t\t\twords.insert(4, \"\");\n\t\t\telse:\n\t\t\t\twords.insert(4, latList[i] + \" \" + longList[i]);\n\t\t\ttarget.write(\",\".join(words));\n\t\ti = i + 1;\n\ttarget.close();\ncombineTables();",
					"codeType": "python",
		...
		{
			"id": "46666665-44c6-499e-9280-b55c523a1b79",
			"x": -435.165218671709,
			"y": 9.661647890107846,
			"label": "",
			"timestamp": 1479111670786,
			"type": "terminal",
			...
			"actions": [
				{
					"id": "985f9480-7b92-c386-8268-be0869aa1ac4",
					"act": "print",
					"outputFileNames": [
						"table.csv"
					],
					"printType": "table",
					"resourceid": "e5b60c83-53d7-4810-6ac1-cdb7412e629f"
				}
			]
		}
	],
	"edges": [
		...
		{
			"from": "d7cd0a5f-cc31-4cb7-8898-7caaa30df6dd",
			"to": "9b759f7b-9c3a-4b08-a7a2-884368adfcc8",
			"id": "afe18eec-ed94-4bda-8c54-5c78c1123727",
			"arrows": "to",
			"label": "ageTable.xml\n",
			"resources": [
				{
		...
		},
		{
			...
			"to": "7d9ae066-ba8a-42fa-8c5f-b2c0cc3c49c5",
			"id": "d2a61608-5cc9-4107-94c2-44b4b89fd6b9",
			"arrows": "to",
			"label": "GPlates Paleo-geographic Coordinates\n",
			"resources": [
				{
		...
		{
			"from": "9b759f7b-9c3a-4b08-a7a2-884368adfcc8",
			"to": "7d9ae066-ba8a-42fa-8c5f-b2c0cc3c49c5",
			"id": "ce5636ae-ba9b-4429-91e8-59f14faf7a2a",
			"arrows": "to",
			"label": "gplates.xml\n",
			"resources": [
				{
		...
		{
			"from": "7d9ae066-ba8a-42fa-8c5f-b2c0cc3c49c5",
			"to": "5ed10548-2586-49dd-921b-dfa3d94f5a7f",
			"id": "315050ac-f458-4427-8a2f-caebf4215ff0",
			"arrows": "to",
			"label": "cords.xml\n",
			"resources": [
				{
		...
		},
		{
			...
			"to": "5ed10548-2586-49dd-921b-dfa3d94f5a7f",
			"id": "64452c5b-d7bf-4543-ae81-f3dc75673ab6",
			"arrows": "to",
			"label": "comTable.csv\n",
			"resources": [
				{
		...
		{
			"from": "5ed10548-2586-49dd-921b-dfa3d94f5a7f",
			"to": "46666665-44c6-499e-9280-b55c523a1b79",
			"id": "9c3483ca-8a1e-4c48-9234-1b03668f07a7",
			"arrows": "to",
			"label": "table.csv\n",
			"resources": [
				{
